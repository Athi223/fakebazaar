...
export default function Authenticate() {
	...
	return (
		<div className="modal fade" id="authenticateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="authenticateModalLabel" aria-hidden="true">
			<div className="modal-dialog modal-dialog-centered">
				<div className="modal-content">
					<div className="modal-header">
						<h5 className="modal-title" id="authenticateModalLabel">Sign In to your Account</h5>
					...
					<div className="modal-body">
						<form onSubmit={authenticate}>
							<div className="mb-3">
								...
								<input value={username} onChange={e => setUsername(e.target.value)} type="text" className="form-control" id="username" required />
							</div>
							<div className="mb-3">
